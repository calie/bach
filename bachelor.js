...
var hannahB = new Contestant(2, "Hannah B", 28, 30, 26, 30, 30, true, 2
);
var cassie = new Contestant(3, "Cassie", 27, 24, 22, 24, 29, true, 2
);
var caelynn = new Contestant(4, "Caelynn", 26, 25, 28, 28, 28, true, 2
);
var demi = new Contestant(5, "Demi", 25, 21, 23, 20, 18, true, 2
);
var laura = new Contestant(6, "Laura", 24, 16, 29, 11, 27, false, 0
);
var hannahG = new Contestant(7, "Hannah G", 23, 18, 15, 27, 26, true, 2
);
...
var kirpa = new Contestant(15, "Kirpa", 15, 9, 18, 3, 11, true, 2
);
var tracy = new Contestant(16, "Tracy", 14, 2, 19, 7, 0, true, 2
);
var sydney = new Contestant(17, "Sydney", 13, 15, 9, 8, 25, true, 2
);
var nicole = new Contestant(18, "Nicole", 12, 10, 14, 9, 21, true, 2
);
var heather = new Contestant(19, "Heather", 11, 11, 0, 5, 8, true, 2
);
var erika = new Contestant(20, "Erika", 10, 17, 21, 15, 20, true, 1
);
var elyse = new Contestant(21, "Elyse", 9, 12, 13, 23, 19, true, 2
);
var tayshia = new Contestant(22, "Tayshia", 8, 4, 10, 26, 13,true, 2
);
var revian = new Contestant(23, "Revian", 7, 3, 16, 2, 15, false, 0
);
var angelique = new Contestant(24, "Angelique", 6, 1, 0, 1, 7, true,1 
);
var court = new Contestant(25, "Courtney", 5, 14, 11, 13, 7, false, 2
);
var devin = new Contestant(26, "Devin", 4, 19, 8, 12, 17, false, 0
);
var tahzjuan = new Contestant(27, "Tahjuan", 3, 5, 0, 4, 9, false, 0
);
var katie = new Contestant(28, "Katie", 2, 8, 0, 10, 10, true, 2
);
var onyeka = new Contestant(29, "Onyeka", 1, 6, 0, 19, 14, true, 2
);
...
function createVanessaList(){
    ...
    for(i=29; i <= 29 && i >= 0; i--){
        ...
        var list = contestantsArray.find(isI); 
        html += '<tr><td>'+caliesList.first + '</td><td>' + caliesList.calie + '</td></tr>';
    }
    document.getElementById('vanessasDOMlist').innerHTML+= html;
}
