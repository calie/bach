...
var hannahB = new Contestant(2, "Hannah B", 28, 30, 26, 30, 30, true, 3
);
var cassie = new Contestant(3, "Cassie", 27, 24, 22, 24, 29, true, 3
);
var caelynn = new Contestant(4, "Caelynn", 26, 25, 28, 28, 28, true, 3
);
var demi = new Contestant(5, "Demi", 25, 21, 23, 20, 18, true, 3
);
var laura = new Contestant(6, "Laura", 24, 16, 29, 11, 27, false, 0
);
var hannahG = new Contestant(7, "Hannah G", 23, 18, 15, 27, 26, true, 3
);
...
var kirpa = new Contestant(15, "Kirpa", 15, 9, 18, 3, 11, true, 3
);
var tracy = new Contestant(16, "Tracy", 14, 2, 19, 7, 0, true, 3
);
var sydney = new Contestant(17, "Sydney", 13, 15, 9, 8, 25, true, 3
);
var nicole = new Contestant(18, "Nicole", 12, 10, 14, 9, 21, true, 3
);
var heather = new Contestant(19, "Heather", 11, 11, 0, 5, 8, true, 3
);
var erika = new Contestant(20, "Erika", 10, 17, 21, 15, 20, true, 1
);
var elyse = new Contestant(21, "Elyse", 9, 12, 13, 23, 19, true, 3
);
var tayshia = new Contestant(22, "Tayshia", 8, 4, 10, 26, 13,true, 3
);
...
var katie = new Contestant(28, "Katie", 2, 8, 0, 10, 10, true, 3
);
var onyeka = new Contestant(29, "Onyeka", 1, 6, 0, 19, 14, true, 3
);
